(function() {
  ...
  (function(root, factory) {
    ...
    JSRel = (function() {
      ...
      function JSRel(uniqId, name, _storage, _autosave, format, tblData) {
        var colData, tblName;
      ...
      JSRel.use = function(uniqId, options) {
        var dbJSONstr, format, name, storage, stored, tblData;
        uniqId || err("uniqId is required and must be non-zero value.");
        uniqId = uniqId.toString();
        stored = this._dbInfos[uniqId];
        if (stored != null) {
          if (options != null ? options.__create : void 0) {
        ...
        if (!options.storage) {
          options.storage = (isNode || isTitanium ? "file" : isBrowser ? "local" : "mock");
        }
      ...
      JSRel.$import = function(uniqId, dbJSONstr, options) {
        ...
        return new JSRel(uniqId, name, storage, autosave, d.f, d.t);
      };
